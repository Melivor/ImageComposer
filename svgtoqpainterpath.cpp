...
QList<QPainterPath> SvgToQPainterPath::getElements(const QString filename)
{
...
void SvgToQPainterPath::pathArc(QPainterPath &path,
                    qreal               rx,
                    qreal               ry,
...
bool SvgToQPainterPath::parsePathDataFast(const QString &dataStr, QPainterPath &path)
{
